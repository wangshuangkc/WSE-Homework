...
public abstract class Indexer {
  ...
  protected SearchEngine.Options _options = null;
  ...
  public Indexer(SearchEngine.Options options) {
    _options = options;
  }
  ...
  public static class Factory {
    public static Indexer getIndexerByOption(SearchEngine.Options options) {
